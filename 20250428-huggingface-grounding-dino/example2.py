...
if __name__ == '__main__':
    ...
    pred = engine(image, ['resistor', 'capacitor', 'chip'])
    for box, score, label in zip(*pred):
        ...
        label_text = f'{label} {int(100 * score)}'
        text_box = draw.textbbox([box[0] + 5, box[1]], label_text, font=font)
        draw.rectangle(
            (
        ...
        draw.text((box[0] + 5, box[1]), label_text, align='center', font=font)
    image.save('example-image-2.png')
